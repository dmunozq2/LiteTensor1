package com.example.detectorobjeto;
...
import com.example.detectorobjeto.ml.Model9noIT;
...
public class MainActivity extends AppCompatActivity
        implements OnSuccessListener<Text>, OnFailureListener , ImageReader.OnImageAvailableListener
{
    ...
    public void PersonalizedModel(View v) {
        try {
            Model9noIT model = Model9noIT.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            Model9noIT.Outputs outputs = model.process(image);
    ...
    public void Detectarobjeto(View v) {
